...
description: >
  Structured code and PR review using Fable 5's review methodology.
  Load when reviewing a pull request, diff, code change, or when the
  user asks for a code review, second opinion, or PR feedback.
  Covers correctness, altitude, efficiency, security, maintainability.
---
...
consumers, unhandled edge cases.

### Altitude
Check that changes are at right depth. Special cases layered on shared
infrastructure signal the fix isn't deep enough — prefer generalizing the
